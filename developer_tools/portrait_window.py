...
class PortraitWindow(PersistentWindowMixin, QWidget):
    ...
    def set_background(self, pixmap):
        if not pixmap.isNull():
            # The incoming pixmap is pre-cropped to the correct aspect ratio.
            # We scale it to fill the entire 1150x1920 scene.
    ...
    def set_style(self):
        ...
        # The specific button styles will be handled in on_selection_changed
