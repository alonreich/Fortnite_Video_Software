...
class MergerUIOverlayMixin:
    def _ensure_processing_overlay(self):
        ...
        # Fix #31: Prevent re-entry clicks
    ...
    def _show_processing_overlay(self):
        ...
        if not hasattr(self.parent, "_pulse_timer"):
            ...
            self.parent._pulse_timer.setInterval(50) # Smooth pulse
    ...
    def _hide_processing_overlay(self):
        ...
        self.parent.btn_merge.setObjectName("mergeButton") # Re-apply ID style
    ...
    def _pulse_merge_btn(self):
        ...
        # Fix #90: Pulse between Green and Dark Green (Success colors), not red
        r = int(39 * k + 30 * (1 - k))
        g = int(174 * k + 100 * (1 - k))
        b = int(96 * k + 60 * (1 - k))
