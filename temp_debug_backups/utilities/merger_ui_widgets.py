...
class MergerUIWidgetsMixin:
    ...
    def create_merge_row(self):
        ...
        self.parent.btn_cancel_merge = QPushButton("Cancel Merge")
        self.parent.btn_cancel_merge.setObjectName("danger-btn")
        self.parent.btn_cancel_merge.setFixedSize(210, 45)
        self.parent.btn_cancel_merge.setCursor(Qt.PointingHandCursor)
        self.parent.btn_cancel_merge.clicked.connect(self.parent.cancel_processing)
        self.parent.btn_cancel_merge.hide()
        self.parent.merge_row.addWidget(self.parent.btn_merge)
        self.parent.merge_row.addWidget(self.parent.btn_cancel_merge)
        self.parent.merge_row.addStretch(1)
