...
class Ui_CropApp:
    def setupUi(self, CropAppWindow):
        ...
        wizard_layout.setContentsMargins(16, 16, 16, 16)
        ...
        CropAppWindow.mpv_error_label.setStyleSheet(f"color: {UI_COLORS.DANGER_HOVER}; font-weight: bold; font-size: 16px; background: {UI_COLORS.OVERLAY_DIM}; padding: 24px; border-radius: 8px;")
        ...
        draw_hint_layout.setContentsMargins(24, 16, 24, 16)
        ...
        CropAppWindow.controls_frame.setFixedHeight(UI_LAYOUT.BUTTON_HEIGHT + 16)
        ...
        CropAppWindow.upload_overlay = UploadOverlay(CropAppWindow.open_button, CropAppWindow.video_frame, CropAppWindow.video_frame)
        ...
        CropAppWindow.cropping_hint_overlay = UploadOverlay(CropAppWindow.snapshot_button, CropAppWindow.video_frame, CropAppWindow.video_frame, "Click \"Start Cropping\" When Ready!")
        ...
        CropAppWindow.play_pause_button.setFixedSize(UI_LAYOUT.BTN_WIDTH_MD, UI_LAYOUT.PORTRAIT_BUTTON_HEIGHT)
        ...
        portrait_header_layout.setContentsMargins(16, 4, 16, 4)
        portrait_header_layout.setSpacing(16)
        ...
        CropAppWindow.transparency_slider.setFixedHeight(24)
        ...
        portrait_header_layout.addSpacing(48)
        portrait_header_layout.addWidget(CropAppWindow.done_button)
        portrait_header_layout.addSpacing(64)
        ...
        CropAppWindow.portrait_scene.setBackgroundBrush(QBrush(QColor(UI_COLORS.BACKGROUND_DARK)))
        ...
        CropAppWindow.portrait_view.setBackgroundBrush(QBrush(QColor(UI_COLORS.BACKGROUND_DARK)))
        CropAppWindow.portrait_view.setStyleSheet(f"background: {UI_COLORS.BACKGROUND_DARK}; border: none;")
        ...
        CropAppWindow.undo_button.setFixedWidth(UI_LAYOUT.BTN_WIDTH_SM)
        CropAppWindow.redo_button = QPushButton("Redo")
        CropAppWindow.redo_button.setToolTip("Forward one step if you undo too much.")
        CropAppWindow.redo_button.setFixedWidth(UI_LAYOUT.BTN_WIDTH_SM)
        undo_redo_container.setFixedWidth(UI_LAYOUT.BTN_WIDTH_MD) 
        ur_outer_layout = QHBoxLayout(undo_redo_container)
        ur_outer_layout.setContentsMargins(16, 0, 16, 0)
        undo_redo_vbox = QVBoxLayout()
        undo_redo_vbox.setSpacing(32)
        ...
        CropAppWindow.layer_list.setFixedWidth(184)
        ...
        portrait_footer_layout.setContentsMargins(16, 4, 16, 16)
        portrait_footer_layout.setSpacing(32)
        ...
        CropAppWindow.delete_button.setFixedWidth(UI_LAYOUT.BTN_WIDTH_MD)
        CropAppWindow.raise_button = QPushButton("Up One Level")
        CropAppWindow.raise_button.setToolTip("Bring this item to the front so it sits on top of others.")
        CropAppWindow.raise_button.setFixedWidth(UI_LAYOUT.BTN_WIDTH_LG)
        ...
        main_layout.addWidget(left_pane_widget, 1176)
        main_layout.addWidget(central_divider)
        main_layout.addWidget(right_pane_widget, 624)
        ...
        for btn in [CropAppWindow.open_button, CropAppWindow.snapshot_button, CropAppWindow.magic_wand_button,
            ...
            if not isinstance(btn, (QCheckBox, QSlider)):
                if btn is CropAppWindow.play_pause_button:
                    btn.setFixedSize(UI_LAYOUT.BTN_WIDTH_MD, UI_LAYOUT.PORTRAIT_BUTTON_HEIGHT)
                else:
