...
class UiBuilderMixin:
    ...
    def init_ui(self):
        ...
        self.start_ms_input.setFixedHeight(35)
        ...
        self.end_ms_input.setFixedHeight(35)
        ...
        self.start_ms_input.valueChanged.connect(self._on_trim_spin_changed)
        ...
        for spin in (self.start_minute_input, self.start_second_input, self.start_ms_input, self.end_minute_input, self.end_second_input, self.end_ms_input):
        ...
        start_ms_layout = QHBoxLayout(); start_ms_layout.setContentsMargins(0,0,0,0); start_ms_layout.setSpacing(0)
        ...
        end_ms_layout = QHBoxLayout(); end_ms_layout.setContentsMargins(0,0,0,0); end_ms_layout.setSpacing(0)
        ...
        lbl_start_ms = QLabel("ms:");         lbl_start_ms.setStyleSheet("font-size: 10px;")
        ...
        lbl_end_ms   = QLabel("ms:");         lbl_end_ms.setStyleSheet("font-size: 10px;")
        ...
        start_ms_layout.addWidget(lbl_start_ms); start_ms_layout.addWidget(self.start_ms_input)
        ...
        end_ms_layout.addWidget(lbl_end_ms); end_ms_layout.addWidget(self.end_ms_input)
        start_group = QHBoxLayout(); start_group.setContentsMargins(0,0,0,0); start_group.setSpacing(0)
        start_group.addLayout(start_min_layout); start_group.addLayout(start_sec_layout); start_group.addLayout(start_ms_layout)
        end_group = QHBoxLayout();   end_group.setContentsMargins(0,0,0,0);   end_group.setSpacing(0)
        end_group.addLayout(end_min_layout);     end_group.addLayout(end_sec_layout); end_group.addLayout(end_ms_layout)
        ...
        self._safe_add_to_grid(process_controls, self.right_group_widget, 0, 2, 1, 1)
