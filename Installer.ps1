...
%PY_EXE%%PY_PFX% -m pip install Pillow --timeout 300 --retries 3 --no-warn-script-location
if errorlevel 1 exit /b 5
%PY_EXE%%PY_PFX% -m pip install pypiwin32 --timeout 300 --retries 3 --no-warn-script-location
if errorlevel 1 exit /b 6
%PY_EXE%%PY_PFX% -m pip install pynput --timeout 300 --retries 3 --no-warn-script-location
if errorlevel 1 exit /b 7
%PY_EXE%%PY_PFX% -m pip install opencv-python --timeout 300 --retries 3 --no-warn-script-location
if errorlevel 1 exit /b 8
%PY_EXE%%PY_PFX% -m pip install PyQtWebEngine --timeout 900 --retries 3 --no-warn-script-location
exit /b 0
"@
