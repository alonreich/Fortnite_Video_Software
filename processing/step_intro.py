...
class IntroProcessor:
    ...
    def create_intro(self, input_path, intro_abs_time, intro_still_sec, is_mobile, audio_kbps, video_bitrate_kbps, progress_signal, is_canceled_func, sample_rate=48000):
