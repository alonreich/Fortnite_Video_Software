...
class UiBuilderMixin:
    ...
    def _set_video_controls_enabled(self, enabled: bool):
        ...
        for widget in [
            ...
            self.music_button, self.positionSlider,
    ...
    def _build_right_panel(self):
        ...
        music_btn_layout.setContentsMargins(5, 0, 5, 0)
        music_btn_layout.setSpacing(2)
        note_l = QLabel("♪")
        note_l.setStyleSheet("font-size: 16px; color: white; background: transparent; border: none;")
        note_l.setAttribute(Qt.WA_TransparentForMouseEvents)
        txt_lbl = QLabel("ADD MUSIC")
        txt_lbl.setStyleSheet("font-size: 11px; color: white; font-weight: bold; background: transparent; border: none;")
        txt_lbl.setAttribute(Qt.WA_TransparentForMouseEvents)
        note_r = QLabel("♪")
        note_r.setStyleSheet("font-size: 16px; color: white; background: transparent; border: none;")
        note_r.setAttribute(Qt.WA_TransparentForMouseEvents)
        music_btn_layout.addStretch()
        music_btn_layout.addWidget(note_l)
        music_btn_layout.addWidget(txt_lbl)
        music_btn_layout.addWidget(note_r)
        music_btn_layout.addStretch()
        right_col.addWidget(self.music_button)
    ...
    def _update_ui_positions(self, checked=False):
